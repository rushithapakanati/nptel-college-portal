import { c as createLucideIcon, r as reactExports, u as useComposedRefs, a as useControllableState, j as jsxRuntimeExports, P as Primitive, b as composeEventHandlers, d as usePrevious, e as useSize, f as createContextScope, g as cn, h as commonjsGlobal, i as getDefaultExportFromCjs, k as clsx, R as React, l as invariant, m as useNavigate, n as useParams, o as useAppContext, p as ue, B as BRANCHES, q as Button, A as ArrowLeft, S as ShieldCheck, s as motion, t as BookOpen, C as CircleAlert, U as Users, L as Label$1, I as Input, v as Select, w as SelectTrigger, x as SelectValue, y as SelectContent, z as SelectItem, E as Eye, D as parseFile, F as getFileHeaders, G as parseCourseRows, H as validateEnrollmentRows, J as validateExamRegRows, K as parseExamRegRecords, M as crossMatchEnrollmentExamReg, N as parseExamShuffleRows } from "./index-pRunsA94.js";
import { B as Badge, L as LogOut, T as Tabs, a as TabsList, b as TabsTrigger, c as TabsContent, C as CircleCheck, d as Card, e as CardContent, f as CardHeader, g as CardTitle, h as Table, i as TableHeader, j as TableRow, k as TableHead, l as TableBody, m as TableCell, n as CardDescription, D as Dialog, o as DialogContent, p as DialogHeader, q as DialogTitle } from "./tabs-D0AoIyrw.js";
import { R as RefreshCw, U as Upload, F as FileText, S as Save, P as PenLine, T as Trash2, C as CirclePlus, a as Funnel, D as Download } from "./upload-Zdx8syIk.js";
...
async function downloadErrorsAsExcel(errors, filename) {
  const XLSX = window.XLSX;
  if (!XLSX) {
    const header = "Student ID,Email,Course ID,Course Name,Error Type,Description,Branch";
    const rows = errors.map(
      (e3) => [
        `"${e3.studentId}"`,
        `"${e3.email}"`,
        `"${e3.courseId}"`,
        `"${(e3.courseName || "").replace(/"/g, '""')}"`,
        `"${e3.errorType}"`,
        `"${(e3.description || "").replace(/"/g, '""')}"`,
        `"${e3.branch}"`
      ].join(",")
    );
    ...
    a2.href = url;
    a2.download = filename.replace(".xlsx", ".csv");
    a2.click();
    URL.revokeObjectURL(url);
    return;
  }
  const rowData = errors.map((e3) => ({
    "Student ID": e3.studentId,
    Email: e3.email,
    "Course ID": e3.courseId,
    "Course Name": e3.courseName || "",
    "Error Type": e3.errorType,
...
function classifyPaymentStatus(status) {
  ...
  const s2 = status.toLowerCase().replace(/[_\s]/g, "").trim();
  if (s2 === "paymentcomplete" || s2 === "complete" || s2 === "paymentsuccess" || s2 === "success" || s2 === "paymentfailed" || s2 === "failed") {
    if (s2 === "paymentcomplete" || s2 === "complete" || s2 === "paymentsuccess" || s2 === "success")
      return "done";
    return "redo";
  }
  if (s2 === "paymentpending" || s2 === "pending" || s2 === "paymentdraft" || s2 === "draft")
    return "redo";
  return "doFirst";
}
function getErrorBadgeClass(errorType) {
  const t2 = errorType.toLowerCase();
  if (t2.includes("missing")) return "bg-red-100 text-red-700 border-red-300";
  if (t2.includes("invalid") || t2.includes("format"))
    return "bg-orange-100 text-orange-700 border-orange-300";
  if (t2.includes("mismatch") || t2.includes("cross"))
    return "bg-yellow-100 text-yellow-700 border-yellow-300";
  if (t2.includes("payment") || t2.includes("redo"))
...
function ErrorTable({
  ...
  const themeClass = theme === "blue" ? "bg-blue-50/60" : theme === "purple" ? "bg-purple-50/60" : "bg-muted/50";
  const headClass = theme === "blue" ? "text-blue-700" : theme === "purple" ? "text-purple-700" : "";
  if (errors.length === 0) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-12 text-muted-foreground", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-10 w-10 mx-auto mb-2 text-green-400" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No errors found for selected filters." })
    ] });
  }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground px-1", children: [
      ...
      " of",
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: errors.length }),
      " errors"
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "div",
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: themeClass, children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: headClass, children: "#" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: headClass, children: "Branch" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: headClass, children: "Roll No" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: headClass, children: "Email" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: headClass, children: "Course Name" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: headClass, children: "Course ID" }),
            showPaymentStatus && /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: headClass, children: "Payment Status" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: headClass, children: "Error Type" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: headClass, children: "Details" })
          ] }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: errors.map((err, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            TableRow,
            {
              "data-ocid": `${ocidPrefix}.row.${i + 1}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-muted-foreground text-xs", children: (page - 1) * pageSize + i + 1 }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-xs", children: err.branch }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-mono text-sm", children: err.studentId }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-sm max-w-[160px] truncate", children: err.email }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-sm max-w-xs", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-primary truncate block", children: err.courseName || "-" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-mono text-sm", children: err.courseId }),
                showPaymentStatus && /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Badge,
                  {
                    variant: "outline",
                    className: "text-xs border-amber-400 text-amber-700 bg-amber-50",
                    children: "paymentStatus" in err ? err.paymentStatus || "N/A" : "N/A"
                  }
                ) }),
...
function DeanDashboard() {
  ...
  const [viewErrorDialog, setViewErrorDialog] = reactExports.useState(null);
  const [parsingFile, setParsingFile] = reactExports.useState(null);
  const [pendingPerms, setPendingPerms] = reactExports.useState(
    JSON.parse(JSON.stringify(hodPermissions))
  );
  const courseFileRef = reactExports.useRef(null);
  const studentDataFileRef = reactExports.useRef(null);
  const examRegFileRef = reactExports.useRef(null);
  const shuffleFileRef = reactExports.useRef(null);
  const [courseFileName, setCourseFileName] = reactExports.useState(null);
  const [enrollmentFileNames, setEnrollmentFileNames] = reactExports.useState([]);
  const [examRegFileNames, setExamRegFileNames] = reactExports.useState([]);
  const [shuffleFileNames, setShuffleFileNames] = reactExports.useState([]);
  const [courseFileHeaders, setCourseFileHeaders] = reactExports.useState([]);
  const [enrollmentFileHeaders, setEnrollmentFileHeaders] = reactExports.useState(
    []
  );
  const [enrollBranchCounts, setEnrollBranchCounts] = reactExports.useState({});
  const [crossMatchErrors, setCrossMatchErrors] = reactExports.useState(
    []
  );
  const [selectedEnrollmentSnapshotIdx, setSelectedEnrollmentSnapshotIdx] = reactExports.useState(null);
  const [selectedExamRegSnapshotIdx, setSelectedExamRegSnapshotIdx] = reactExports.useState(null);
  const [errorBranchFilter, setErrorBranchFilter] = reactExports.useState("All");
  const [errorTypeFilter, setErrorTypeFilter] = reactExports.useState("All");
  const [errorPage, setErrorPage] = reactExports.useState(1);
  const [enrollErrBranchFilter, setEnrollErrBranchFilter] = reactExports.useState("All");
  const [enrollErrTypeFilter, setEnrollErrTypeFilter] = reactExports.useState("All");
  const [enrollErrPage, setEnrollErrPage] = reactExports.useState(1);
  const [examErrBranchFilter, setExamErrBranchFilter] = reactExports.useState("All");
  const [examErrTypeFilter, setExamErrTypeFilter] = reactExports.useState("All");
  const [examErrPage, setExamErrPage] = reactExports.useState(1);
  const [coursePage, setCoursePage] = reactExports.useState(1);
  const [donePage, setDonePage] = reactExports.useState(1);
  const [hodEditPage, setHodEditPage] = reactExports.useState(1);
  const [doneBranchFilter, setDoneBranchFilter] = reactExports.useState("All");
  const PAGE_SIZE = 50;
  ...
  function handleRefresh() {
    ue.success("Dashboard data refreshed.");
  }
  const savePerms = reactExports.useCallback(
    (branch) => {
      updateHodPermission(branch, pendingPerms[branch]);
      ue.success(`Permissions saved for ${branch} HOD.`);
    },
    [updateHodPermission, pendingPerms]
  );
  const openErrorDialog = reactExports.useCallback((err) => {
    setViewErrorDialog({
  ...
  async function handleCourseUpload(e3) {
    var _a;
    const file = (_a = e3.target.files) == null ? void 0 : _a[0];
    if (!file) return;
    setCourseFileName(file.name);
    try {
      ue.info(`Parsing course file "${file.name}"...`);
      ...
      ue.success(`Course file loaded — ${courses.length} 12-week courses.`);
  ...
  async function handleStudentDataUpload(e3) {
    var _a;
    const file = (_a = e3.target.files) == null ? void 0 : _a[0];
    if (!file) return;
    e3.target.value = "";
    ...
    try {
      ...
      const uploadedCourseIds = uploadedCourses.map((c2) => c2.courseId);
  ...
  function handleRemoveEnrollmentFile(fileName) {
    const newList = enrollmentFileNames.filter((n2) => n2 !== fileName);
  ...
  async function handleExamRegUpload(e3) {
    var _a;
    const file = (_a = e3.target.files) == null ? void 0 : _a[0];
    if (!file) return;
    e3.target.value = "";
    try {
      ue.info(`Parsing exam registration file "${file.name}"...`);
      const rows = await parseFile(file);
      const enrollmentIds = uploadedStudentRecords.map((r) => r.studentId);
      const courseIdsForValidation = uploadedCourses.map((c2) => c2.courseId);
  ...
  function handleRemoveExamRegFile(fileName) {
    const newList = examRegFileNames.filter((n2) => n2 !== fileName);
  ...
  async function handleShuffleUpload(e3) {
    var _a;
    const file = (_a = e3.target.files) == null ? void 0 : _a[0];
    if (!file) return;
    e3.target.value = "";
    try {
      ue.info(`Parsing shuffle file "${file.name}"...`);
      const rows = await parseFile(file);
  ...
  function handleRemoveShuffleFile(fileName) {
    const newList = shuffleFileNames.filter((n2) => n2 !== fileName);
  ...
  const enrollBranchStats = reactExports.useMemo(
    () => BRANCHES.map((b2) => ({
      branch: b2,
      total: enrollBranchCounts[b2] ?? 0,
      errors: enrollmentErrors.filter((e3) => e3.branch === b2).length
    })),
    [enrollBranchCounts, enrollmentErrors]
  );
  const examRegBranchStats = reactExports.useMemo(() => {
    const statsMap = /* @__PURE__ */ new Map();
    for (const b2 of BRANCHES) {
      statsMap.set(b2, { total: 0, done: 0, redo: 0, doFirst: 0, errors: 0 });
    }
    ...
    for (const e3 of examRegErrors) {
      const stats = statsMap.get(e3.branch);
      if (stats) stats.errors++;
    }
    return BRANCHES.map((b2) => ({
      branch: b2,
      ...statsMap.get(b2) ?? {
        total: 0,
        done: 0,
  ...
  const totalDone = reactExports.useMemo(
    () => examRegBranchStats.reduce((a2, b2) => a2 + b2.done, 0),
    [examRegBranchStats]
  );
  const totalRedo = reactExports.useMemo(
    () => examRegBranchStats.reduce((a2, b2) => a2 + b2.redo, 0),
    [examRegBranchStats]
  );
  const totalDoFirst = reactExports.useMemo(
    () => examRegBranchStats.reduce((a2, b2) => a2 + b2.doFirst, 0),
    [examRegBranchStats]
  );
  ...
  const doneRegistrations = reactExports.useMemo(
    () => uploadedExamRegRecords.filter(
      (r) => classifyPaymentStatus(r.paymentStatus) === "done"
    ),
    [uploadedExamRegRecords]
  );
  const filteredDoneRegs = reactExports.useMemo(
    () => doneBranchFilter === "All" ? doneRegistrations : doneRegistrations.filter((r) => r.branch === doneBranchFilter),
    [doneRegistrations, doneBranchFilter]
  );
  const pagedDoneRegs = reactExports.useMemo(
  ...
  const filteredCourses = reactExports.useMemo(() => displayCourses, [displayCourses]);
  const pagedCourses = reactExports.useMemo(
  ...
  const allCombinedErrors = reactExports.useMemo(
    () => [
      ...enrollmentErrors.map((e3) => ({
        ...e3,
        _source: "Enrollment"
      })),
      ...examRegErrors.map((e3) => ({ ...e3, _source: "Exam Reg" }))
    ],
    [enrollmentErrors, examRegErrors]
  );
  const filteredAllErrors = reactExports.useMemo(
    () => allCombinedErrors.filter((e3) => {
      const branchMatch = errorBranchFilter === "All" || e3.branch === errorBranchFilter;
      const typeMatch = errorTypeFilter === "All" || e3.errorType === errorTypeFilter;
      return branchMatch && typeMatch;
    }),
    [allCombinedErrors, errorBranchFilter, errorTypeFilter]
  );
  const uniqueAllErrorTypes = reactExports.useMemo(
    () => Array.from(new Set(allCombinedErrors.map((e3) => e3.errorType))),
    [allCombinedErrors]
  );
  const totalAllErrorPages = Math.ceil(filteredAllErrors.length / PAGE_SIZE);
  const pagedAllErrors = reactExports.useMemo(
  ...
  const filteredEnrollErrors = reactExports.useMemo(
    () => enrollmentErrors.filter((e3) => {
      const branchMatch = enrollErrBranchFilter === "All" || e3.branch === enrollErrBranchFilter;
      const typeMatch = enrollErrTypeFilter === "All" || e3.errorType === enrollErrTypeFilter;
      return branchMatch && typeMatch;
    }),
    [enrollmentErrors, enrollErrBranchFilter, enrollErrTypeFilter]
  );
  const uniqueEnrollErrTypes = reactExports.useMemo(
    () => Array.from(new Set(enrollmentErrors.map((e3) => e3.errorType))),
    [enrollmentErrors]
  );
  const totalEnrollErrPages = Math.ceil(
    filteredEnrollErrors.length / PAGE_SIZE
  );
  const pagedEnrollErrors = reactExports.useMemo(
  ...
  const filteredExamRegErrList = reactExports.useMemo(
    () => examRegErrors.filter((e3) => {
      const branchMatch = examErrBranchFilter === "All" || e3.branch === examErrBranchFilter;
      const typeMatch = examErrTypeFilter === "All" || e3.errorType === examErrTypeFilter;
      return branchMatch && typeMatch;
    }),
    [examRegErrors, examErrBranchFilter, examErrTypeFilter]
  );
  const uniqueExamErrTypes = reactExports.useMemo(
    () => Array.from(new Set(examRegErrors.map((e3) => e3.errorType))),
    [examRegErrors]
  );
  const totalExamErrPages = Math.ceil(
    filteredExamRegErrList.length / PAGE_SIZE
  );
  const pagedExamErrors = reactExports.useMemo(
  ...
  function UploadCard({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "flex-1", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "font-display text-base flex items-center gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Icon, { className: `h-4 w-4 ${iconColor}` }),
          title
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: description })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "space-y-3", children: [
        isParsing && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 p-3 rounded-lg bg-blue-50 border border-blue-200 text-xs text-blue-700", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-4 w-4 rounded-full border-2 border-blue-500 border-t-transparent animate-spin shrink-0" }),
          "Parsing file…"
        ] }),
        fileNames.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", children: fileNames.map((fname) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-green-700 flex-1 truncate min-w-0", children: fname }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                Button,
                {
                  size: "sm",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "label",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CirclePlus, { className: `h-6 w-6 ${iconColor} shrink-0` }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium text-sm", children: fileNames.length > 0 ? `Upload another ${title.toLowerCase()} file` : `Click to upload ${title} CSV/Excel` }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-0.5", children: "Multiple uploads supported" })
              ] })
            ]
          }
        ),
  ...
  function SnapshotSelector({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 p-3 rounded-lg border bg-muted/30", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs font-semibold text-muted-foreground mb-2 flex items-center gap-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", className: "text-xs", children: "Active" })
            ]
          }
        ),
        snapshots.map((snap, idx) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "button",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground ml-2 shrink-0", children: new Date(snap.timestamp).toLocaleDateString() })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      selectedIdx !== null && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-2 p-2 bg-amber-50 border border-amber-200 rounded text-xs text-amber-800", children: [
        "⚠️ Viewing historical data from",
        " ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: (_a = snapshots[selectedIdx]) == null ? void 0 : _a.fileName }),
  ...
  function ErrorFilterBar({
    ...
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 flex-wrap", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: branchFilter, onValueChange: onBranchChange, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "w-32 h-8", "data-ocid": branchOcid, children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "All", children: "All Branches" }),
          BRANCHES.map((b2) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: b2, children: b2 }, b2))
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Select, { value: typeFilter, onValueChange: onTypeChange, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SelectTrigger, { className: "w-44 h-8", "data-ocid": typeOcid, children: /* @__PURE__ */ jsxRuntimeExports.jsx(SelectValue, {}) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SelectContent, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: "All", children: "All Error Types" }),
          errorTypes.map((t2) => /* @__PURE__ */ jsxRuntimeExports.jsx(SelectItem, { value: t2, children: t2 }, t2))
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
  ...
  const enrollLocalSnapshots = reactExports.useMemo(
    () => enrollmentFileSnapshots.map((s2) => ({
      fileName: s2.fileName,
      timestamp: new Date(s2.uploadedAt).getTime(),
      records: s2.data,
      errors: []
    })),
    [enrollmentFileSnapshots]
  );
  const examRegLocalSnapshots = reactExports.useMemo(
    () => examRegFileSnapshots.map((s2) => ({
      fileName: s2.fileName,
      timestamp: new Date(s2.uploadedAt).getTime(),
      records: s2.data,
      errors: []
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("header", { className: "nptel-gradient text-white", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "container mx-auto px-4 py-4 flex items-center gap-3", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold", children: "Dean Dashboard" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "ml-auto flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-white/20 text-white border-white/30 hidden sm:flex", children: collegeName }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Button,
          {
            variant: "ghost",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: "flex-1 container mx-auto px-4 py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.div,
      {
        initial: { opacity: 0, y: 16 },
        animate: { opacity: 1, y: 0 },
        transition: { duration: 0.5 },
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tabs, { defaultValue: "overview", "data-ocid": "dean.tabs", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              TabsTrigger,
              {
                ...
                children: [
                  ...
                  " All Errors",
                  allCombinedErrors.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Badge,
                    {
                      variant: "destructive",
                      className: "ml-1 text-xs px-1.5 py-0 h-4",
                      children: allCombinedErrors.length
                    }
                  )
                ]
              }
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              TabsTrigger,
              {
                ...
                children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "h-4 w-4" }),
                  " Enrollment Errors",
                  enrollmentErrors.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Badge,
                    {
                      variant: "destructive",
                      className: "ml-1 text-xs px-1.5 py-0 h-4",
                      children: enrollmentErrors.length
                    }
                  )
                ]
              }
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(
              TabsTrigger,
              {
                ...
                children: [
                  ...
                  " Exam Reg Errors",
                  examRegErrors.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Badge,
                    {
                      variant: "destructive",
                      className: "ml-1 text-xs px-1.5 py-0 h-4",
                      children: examRegErrors.length
                    }
                  )
                ]
              }
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "overview", children: !deanStudentDataUploaded ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              "data-ocid": "dean.overview.empty_state",
              className: "flex flex-col items-center gap-4 py-20 text-center text-muted-foreground",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Database, { className: "h-14 w-14 text-muted-foreground/40" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-lg text-foreground", children: "No Student Data Uploaded" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm mt-1 max-w-sm", children: [
                    "Upload student data to see overview statistics. Go to the",
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { children: "Data Upload" }),
                    " tab to get started."
                  ] })
                ] })
              ]
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-blue-700 mb-3 uppercase tracking-wide", children: "Enrollment Overview" }),
                  ...
                  Card,
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-4 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-2xl font-display font-bold mt-0.5", children: stat.value })
                      ] }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Icon,
                        {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-semibold text-purple-700 mb-3 uppercase tracking-wide", children: "Exam Registration Overview" }),
            ...
            deanExamRegDataUploaded && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "font-display text-base", children: "Branch-wise Overview" }) }),
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(TableHeader, { children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "bg-muted/30", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-blue-600 text-xs", children: "Total" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-blue-600 text-xs border-r", children: "Errors" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-purple-600 text-xs", children: "Total" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-purple-600 text-xs", children: "Done" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-purple-600 text-xs", children: "Redo" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-purple-600 text-xs", children: "Do First" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-purple-600 text-xs", children: "Errors" })
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: BRANCHES.map((branch, i) => {
                      ...
                      return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        TableRow,
                        {
                          ...
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "border-r", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "outline", children: branch }) }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-medium text-blue-700", children: (eStats == null ? void 0 : eStats.total) ?? 0 }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "border-r", children: ((eStats == null ? void 0 : eStats.errors) ?? 0) > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                              Badge,
                              {
                                variant: "destructive",
                                className: "text-xs",
                                children: eStats == null ? void 0 : eStats.errors
                              }
                            ) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-600 text-sm", children: "0" }) }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-medium text-purple-700", children: (rStats == null ? void 0 : rStats.total) ?? 0 }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-700 font-medium", children: (rStats == null ? void 0 : rStats.done) ?? 0 }) }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-amber-600 font-medium", children: (rStats == null ? void 0 : rStats.redo) ?? 0 }) }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-red-600 font-medium", children: (rStats == null ? void 0 : rStats.doFirst) ?? 0 }) }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: ((rStats == null ? void 0 : rStats.errors) ?? 0) > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                              Badge,
                              {
                                variant: "destructive",
                                className: "text-xs",
                                children: rStats == null ? void 0 : rStats.errors
                              }
                            ) : /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-600 text-sm", children: "0" }) })
                          ]
                        },
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "data-upload", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 lg:grid-cols-3 gap-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              UploadCard,
              {
                ...
                extra: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  enrollmentFileNames.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground px-1", children: [
                    enrollmentFileRecordCount,
                    " records ·",
                    " ",
                  ...
                  enrollmentFileHeaders.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-lg bg-muted/50 border text-xs text-muted-foreground", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-medium text-foreground", children: [
                      "Detected columns (",
                      enrollmentFileHeaders.length,
                      "):",
                      " "
                    ] }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              UploadCard,
              {
                ...
                extra: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
                  examRegFileNames.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground px-1", children: [
                    examRegFileRecordCount,
                    " records ·",
                    " ",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              UploadCard,
              {
                ...
                extra: shuffleFileNames.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground px-1", children: [
                  uploadedShuffleRecords.length,
                  " shuffle records loaded"
                ] }) : void 0
              }
            )
          ] }) }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "permissions", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "font-display text-base flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { className: "h-4 w-4 text-primary" }),
                "HOD Permissions Management"
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Control upload access and edit credits for each department HOD." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", "data-ocid": "dean.permissions.table", children: BRANCHES.map((branch, i) => {
              ...
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-16", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      Badge,
                      {
                        variant: "outline",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Switch,
                        {
                          ...
                          onCheckedChange: (v2) => setPendingPerms((prev) => ({
                            ...prev,
                            [branch]: { ...prev[branch], canUpload: v2 }
                          })),
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Label$1,
                        {
                          ...
                          children: "Allow Upload"
                        }
                      )
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Label$1, { className: "text-xs text-muted-foreground whitespace-nowrap", children: "Upload Credits:" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        Input,
                        {
                          type: "number",
                          ...
                          onChange: (e3) => setPendingPerms((prev) => ({
                            ...prev,
                            [branch]: {
                              ...prev[branch],
                              uploadCredits: Number(e3.target.value)
                            }
                          })),
                        ...
                        Button,
                        {
                          ...
                          onClick: () => setPendingPerms((prev) => {
                            ...
                            return {
                              ...
                              [branch]: {
                                ...prev[branch],
                                uploadCredits: (((_a = prev[branch]) == null ? void 0 : _a.uploadCredits) ?? 0) + 1
                              }
                            };
                          }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "courses", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardDescription, { children: "Upload master course CSV/Excel for 12-week courses (visible to all HODs and Dean)." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
                courseFileName && deanCourseFileUploaded ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    "data-ocid": "dean.course_upload.success_state",
                    className: "space-y-2",
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 p-4 rounded-lg bg-green-50 border border-green-200", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-5 w-5 text-green-600" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-green-700", children: courseFileName }),
                      ...
                      courseFileHeaders.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 rounded-lg bg-muted/50 border text-xs text-muted-foreground", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-medium text-foreground", children: [
                          "Detected columns:",
                          " "
                        ] }),
                  ...
                  "label",
                  {
                    ...
                    children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Upload, { className: "h-10 w-10 text-primary" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: "Click to upload course CSV/Excel" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground mt-1", children: "Master course list for all branches" })
                      ] })
                    ]
                  }
                ),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "font-display text-base", children: [
                "12-Week Courses",
                deanCourseFileUploaded && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "ml-2 text-sm font-normal text-muted-foreground", children: [
                  "(",
                  filteredCourses.length,
                  " total)"
                ] })
              ] }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: !deanCourseFileUploaded ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium", children: "No Course File Uploaded" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm max-w-sm", children: "Upload a course file above to see the 12-week courses." })
                  ]
                }
                ...
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No 12-week courses found." })
                }
              ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground px-1", children: [
                  "Showing ",
                  (coursePage - 1) * COURSE_PAGE_SIZE + 1,
                  "–",
                  Math.min(
                    coursePage * COURSE_PAGE_SIZE,
                    filteredCourses.length
                  ...
                  "of",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: filteredCourses.length }),
                  " ",
                  "courses"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: pagedCourses.map((c2, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        TableRow,
                        {
                          "data-ocid": `dean.courses.row.${i + 1}`,
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-muted-foreground text-xs", children: (coursePage - 1) * COURSE_PAGE_SIZE + i + 1 }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-mono text-sm", children: c2.courseId }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: c2.courseName }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                              Badge,
                              {
                                variant: "outline",
                                className: "text-xs",
                                children: c2.duration
                              }
                            ) })
                          ]
                        },
                ...
                totalCoursePages > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between pt-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      variant: "outline",
                      size: "sm",
                      onClick: () => setCoursePage((p2) => Math.max(1, p2 - 1)),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      variant: "outline",
                      size: "sm",
                      onClick: () => setCoursePage(
                        (p2) => Math.min(totalCoursePages, p2 + 1)
                      ),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "all-errors", children: noDataUploaded ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              "data-ocid": "dean.errors.empty_state",
              className: "flex flex-col items-center gap-4 py-20 text-center text-muted-foreground",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-14 w-14 text-muted-foreground/40" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-lg text-foreground", children: "No Data Uploaded" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1 max-w-sm", children: "Upload student data to see errors." })
                ] })
              ]
            }
          ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3 justify-between", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "font-display text-base flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(CircleAlert, { className: "h-4 w-4 text-destructive" }),
                  "All Student Errors",
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "destructive", children: filteredAllErrors.length })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  ErrorFilterBar,
                  {
                    ...
                    onBranchChange: (v2) => {
                      setErrorBranchFilter(v2);
                      setErrorPage(1);
                    },
                    typeFilter: errorTypeFilter,
                    onTypeChange: (v2) => {
                      setErrorTypeFilter(v2);
                      setErrorPage(1);
                    },
                    errorTypes: uniqueAllErrorTypes,
                    errors: filteredAllErrors,
                    filename: `all-errors-${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}.xlsx`,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                ErrorTable,
                {
                  ...
                  onPrev: () => setErrorPage((p2) => Math.max(1, p2 - 1)),
                  onNext: () => setErrorPage(
                    (p2) => Math.min(totalAllErrorPages, p2 + 1)
                  ),
                  theme: "default",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "font-display text-base flex items-center gap-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(PenLine, { className: "h-4 w-4 text-indigo-600" }),
                  "HOD Edited Records",
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-indigo-100 text-indigo-800 border-indigo-200 ml-1", children: hodEditedRecords.length })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Records edited by HODs — visible to both HOD and Dean." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: hodEditedRecords.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  "data-ocid": "dean.hod_edits.empty_state",
                  className: "text-center py-10 text-muted-foreground",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(PenLine, { className: "h-10 w-10 mx-auto mb-2 text-muted-foreground/40" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No HOD edits yet. Edits made by HODs will appear here." })
                  ]
                }
              ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground px-1", children: [
                  "Showing ",
                  (hodEditPage - 1) * HOD_EDIT_PAGE_SIZE + 1,
                  "–",
                  Math.min(
                    hodEditPage * HOD_EDIT_PAGE_SIZE,
                  ...
                  "of",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: hodEditedRecords.length }),
                  " ",
                  "edits"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { className: "bg-indigo-50/60", children: [
                        "#",
                        "Branch",
                        "Student ID",
                        "Course ID",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: pagedHodEdits.map((rec, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        TableRow,
                        {
                          "data-ocid": `dean.hod_edits.row.${i + 1}`,
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-muted-foreground text-xs", children: (hodEditPage - 1) * HOD_EDIT_PAGE_SIZE + i + 1 }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                              Badge,
                              {
                                variant: "secondary",
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-mono text-sm", children: rec.courseId }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-sm", children: rec.editedBy }),
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs text-red-600 max-w-[120px] truncate", children: Object.entries(rec.oldValues ?? {}).map(([k2, v2]) => `${k2}: ${v2}`).join(", ") || "-" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs text-green-700 max-w-[120px] truncate", children: Object.entries(rec.newValues ?? {}).map(([k2, v2]) => `${k2}: ${v2}`).join(", ") || "-" })
                          ]
                        },
                        `${rec.id}-${i}`
                      )) })
                ...
                totalHodEditPages > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between pt-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      variant: "outline",
                      size: "sm",
                      onClick: () => setHodEditPage((p2) => Math.max(1, p2 - 1)),
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      variant: "outline",
                      size: "sm",
                      onClick: () => setHodEditPage(
                        (p2) => Math.min(totalHodEditPages, p2 + 1)
                      ),
            ...
            crossMatchErrors.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { className: "border-orange-200", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "font-display text-base flex items-center gap-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-orange-100 text-orange-700 border-orange-300", children: crossMatchErrors.length })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Students enrolled in 12-week courses without exam registration, or exam registered without enrollment" })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "rounded-lg border overflow-x-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { className: "bg-muted/50", children: [
                    "Student ID",
                    "Email",
                    "Course Name",
                    "Course ID",
                    ...
                    "Description",
                    "Branch"
                  ].map((h2) => /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { children: h2 }, h2)) }) }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: crossMatchErrors.slice(0, 100).map((err, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    TableRow,
                    {
                      "data-ocid": `dean.crossmatch.row.${i + 1}`,
                      children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-mono text-xs", children: err.studentId }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs", children: err.email }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-primary text-xs", children: err.courseName || "-" }) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-mono text-xs", children: err.courseId }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                          Badge,
                          {
                            variant: err.errorType === "Missing Exam Registration" ? "destructive" : "outline",
                            className: "text-xs whitespace-nowrap",
                            children: err.errorType
                          }
                        ) }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-xs text-muted-foreground", children: err.details }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                          Badge,
                          {
                            variant: "outline",
                    ...
                    `cm-${err.studentId}-${err.courseId}-${err.errorType}`
                  )) })
                ] }) }),
                crossMatchErrors.length > 100 && /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground mt-2", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "enrollment-errors", children: !deanStudentDataUploaded ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              "data-ocid": "dean.enrollment_errors.empty_state",
              className: "flex flex-col items-center gap-4 py-20 text-center text-muted-foreground",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(BookOpen, { className: "h-14 w-14 text-muted-foreground/40" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-lg text-foreground", children: "No Enrollment Data Uploaded" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1 max-w-sm", children: "Upload student enrollment data first to see enrollment errors." })
                ] })
              ]
            }
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3 justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "font-display text-base flex items-center gap-2", children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-blue-700", children: "Enrollment Errors" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "destructive", children: filteredEnrollErrors.length })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                ErrorFilterBar,
                {
                  ...
                  onBranchChange: (v2) => {
                    setEnrollErrBranchFilter(v2);
                    setEnrollErrPage(1);
                  },
                  typeFilter: enrollErrTypeFilter,
                  onTypeChange: (v2) => {
                    setEnrollErrTypeFilter(v2);
                    setEnrollErrPage(1);
                  },
                  errorTypes: uniqueEnrollErrTypes,
                  errors: filteredEnrollErrors,
                  filename: `enrollment-errors-${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}.xlsx`,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              ErrorTable,
              {
                ...
                onPrev: () => setEnrollErrPage((p2) => Math.max(1, p2 - 1)),
                onNext: () => setEnrollErrPage(
                  (p2) => Math.min(totalEnrollErrPages, p2 + 1)
                ),
                theme: "blue",
                onView: openErrorDialog,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "examreg-errors", children: !deanExamRegDataUploaded ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              "data-ocid": "dean.examreg_errors.empty_state",
              className: "flex flex-col items-center gap-4 py-20 text-center text-muted-foreground",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CircleX, { className: "h-14 w-14 text-muted-foreground/40" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-lg text-foreground", children: "No Exam Registration Data Uploaded" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm mt-1 max-w-sm", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3 justify-between", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "font-display text-base flex items-center gap-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(ClipboardCheck, { className: "h-4 w-4 text-purple-600" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-purple-700", children: "Exam Registration Errors" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "destructive", children: filteredExamRegErrList.length })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                ErrorFilterBar,
                {
                  ...
                  onBranchChange: (v2) => {
                    setExamErrBranchFilter(v2);
                    setExamErrPage(1);
                  },
                  typeFilter: examErrTypeFilter,
                  onTypeChange: (v2) => {
                    setExamErrTypeFilter(v2);
                    setExamErrPage(1);
                  },
                  errorTypes: uniqueExamErrTypes,
                  errors: filteredExamRegErrList,
                  filename: `examreg-errors-${(/* @__PURE__ */ new Date()).toISOString().slice(0, 10)}.xlsx`,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              ErrorTable,
              {
                ...
                onPrev: () => setExamErrPage((p2) => Math.max(1, p2 - 1)),
                onNext: () => setExamErrPage(
                  (p2) => Math.min(totalExamErrPages, p2 + 1)
                ),
                theme: "purple",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(TabsContent, { value: "statistics", children: !deanExamRegDataUploaded ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              "data-ocid": "dean.statistics.empty_state",
              className: "flex flex-col items-center gap-4 py-20 text-center text-muted-foreground",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(ChartColumn, { className: "h-14 w-14 text-muted-foreground/40" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-bold text-lg text-foreground", children: "No Exam Registration Data" }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm mt-1 max-w-sm", children: "Upload the exam registration file to view statistics." })
                ] })
              ]
            }
          ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6", children: [
                ...
                children: [
                  ...
                  return /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Card,
                    {
                      ...
                      children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "pt-5 pb-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-2", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                          /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "p",
                            {
                          ...
                          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: card.desc })
                        ] }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(
                          CardIcon,
                          {
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "font-display text-base", children: "Branch-wise Exam Registration Status" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsx(ResponsiveContainer, { width: "100%", height: "100%", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    BarChart,
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(XAxis, { dataKey: "branch" }),
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "font-display text-base", children: "Overall Distribution" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "font-display text-base", children: "Summary" }) }),
                  ...
                  [
                    ...
                    "div",
                    {
                      ...
                      children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-lg", children: item.value })
                      ]
                    },
                    item.label
                  )),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t pt-3 flex items-center justify-between", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-muted-foreground", children: "Grand Total" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-xl", children: examRegFileRecordCount })
                  ] })
                ] }) })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs(Card, { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardTitle, { className: "font-display text-base", children: "Branch-wise Detailed Statistics" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  className: "rounded-lg border overflow-x-auto",
                  ...
                  children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(TableHeader, { children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "bg-muted/30", children: [
                        ...
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-blue-600 text-xs border-r", children: "Errors" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-purple-600 text-xs", children: "Total" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-green-600 text-xs", children: "Done" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-amber-600 text-xs", children: "Redo" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-red-600 text-xs", children: "Do First" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableHead, { className: "text-purple-600 text-xs", children: "Errors" })
                      ] })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs(TableBody, { children: [
                        ...
                        return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                          TableRow,
                          {
                            ...
                            children: [
                              ...
                              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-medium text-purple-700", children: (rStats == null ? void 0 : rStats.total) ?? 0 }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-medium text-green-700", children: (rStats == null ? void 0 : rStats.done) ?? 0 }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-medium text-amber-600", children: (rStats == null ? void 0 : rStats.redo) ?? 0 }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-medium text-red-600", children: (rStats == null ? void 0 : rStats.doFirst) ?? 0 }),
                              /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: ((rStats == null ? void 0 : rStats.errors) ?? 0) > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                                Badge,
                                {
                                  variant: "destructive",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsxs(TableRow, { className: "bg-muted/30 border-t-2 font-bold", children: [
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "border-r font-display font-bold", children: "Total" }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-bold text-blue-700", children: enrollmentFileRecordCount }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "border-r font-bold text-red-600", children: enrollmentErrors.length }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-bold text-purple-700", children: examRegFileRecordCount }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-bold text-green-700", children: totalDone }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-bold text-amber-600", children: totalRedo }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-bold text-red-600", children: totalDoFirst }),
                        /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-bold text-red-600", children: examRegErrors.length })
                      ] })
                    ] })
                  ] })
                }
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardHeader, { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-center gap-3 justify-between", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(CardTitle, { className: "font-display text-base flex items-center gap-2", children: [
                    ...
                    "Done Registrations",
                    /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-green-100 text-green-800 border-green-200 ml-1", children: doneRegistrations.length })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsxs(
                    Select,
                    {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground mt-1", children: "Students with payment_complete / complete status — registration confirmed." })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { children: filteredDoneRegs.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  "data-ocid": "dean.statistics.done.empty_state",
                  className: "text-center py-10 text-muted-foreground",
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx(CircleCheck, { className: "h-10 w-10 mx-auto mb-2 text-muted-foreground/40" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "No done registrations found yet." })
                  ]
                }
              ) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-foreground px-1", children: [
                  "Showing ",
                  (donePage - 1) * DONE_PAGE_SIZE + 1,
                  "–",
                  Math.min(
                    donePage * DONE_PAGE_SIZE,
                  ...
                  "of",
                  " ",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("strong", { className: "text-foreground", children: filteredDoneRegs.length }),
                  " ",
                  "done registrations"
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Table, { children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(TableHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(TableRow, { className: "bg-green-50", children: [
                        "#",
                        "Roll No",
                        "Email",
                        "Course ID",
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(TableBody, { children: pagedDoneRegs.map((r, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                        TableRow,
                        {
                          "data-ocid": `dean.statistics.done.row.${i + 1}`,
                          children: [
                            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-muted-foreground text-xs", children: (donePage - 1) * DONE_PAGE_SIZE + i + 1 }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-mono text-sm", children: r.studentId }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "text-sm", children: r.email || "-" }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { className: "font-mono text-sm", children: r.courseId }),
                            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                              Badge,
                              {
                                variant: "secondary",
                            ...
                            /* @__PURE__ */ jsxRuntimeExports.jsx(TableCell, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-green-100 text-green-800 border-green-200 text-xs", children: r.paymentStatus }) })
                          ]
                        },
                        `done-${r.studentId}-${i}`
                      )) })
                ...
                totalDonePages > 1 && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between pt-2", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      variant: "outline",
                      size: "sm",
                      onClick: () => setDonePage((p2) => Math.max(1, p2 - 1)),
                      disabled: donePage === 1,
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(
                    Button,
                    {
                      ...
                      size: "sm",
                      onClick: () => setDonePage(
                        (p2) => Math.min(totalDonePages, p2 + 1)
                      ),
    ...
    viewErrorDialog && /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: true, onOpenChange: () => setViewErrorDialog(null), children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      DialogContent,
      {
        className: "max-w-md",
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3 text-sm", children: [
            viewErrorDialog.courseName && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold text-foreground", children: [
                "Course Name:",
                " "
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-bold text-blue-700", children: viewErrorDialog.courseName })
            ] }),
            viewErrorDialog.courseId && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold text-foreground", children: [
                "Course ID:",
                " "
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", children: viewErrorDialog.courseId })
            ] }),
            viewErrorDialog.errorType && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold text-foreground", children: [
                "Error Type:",
                " "
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "destructive", className: "text-xs", children: viewErrorDialog.errorType })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold text-foreground", children: [
                "Description:",
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-foreground", children: viewErrorDialog.description })
            ] }),
            viewErrorDialog.studentId && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold text-foreground", children: [
                "Roll No:",
                " "
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-mono", children: viewErrorDialog.studentId })
            ] }),
            viewErrorDialog.email && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-semibold text-foreground", children: "Email: " }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: viewErrorDialog.email })
            ] }),
            viewErrorDialog.branch && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-semibold text-foreground", children: [
                "Branch:",
                " "
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", children: viewErrorDialog.branch })
            ] })
          ] })
        ]
      }
