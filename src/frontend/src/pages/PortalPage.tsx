...
const YEAR_LABELS: Record<string, string> = {
  "2026-sem1": "2026 Sem-1",
  "2026-sem2": "2026 Sem-2",
};
          ...
          {selectedAcademicYear && (
            <Badge
              ...
              style={{
                ...
                color: "oklch(0.93 0.12 85)",
              }}
            >
              <CalendarDays className="h-3.5 w-3.5" />
              {YEAR_LABELS[selectedAcademicYear] ?? selectedAcademicYear}
            </Badge>
          )}
        </div>
      </header>
            ...
            {selectedAcademicYear && (
              ...
              >
                <Badge
                  ...
                  style={{
                    background: "oklch(0.75 0.16 85 / 0.25)",
                    border: "1px solid oklch(0.75 0.16 85 / 0.6)",
                    color: "oklch(0.93 0.12 85)",
                  }}
                >
                  Academic Year:{" "}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 max-w-5xl mx-auto">
            {COLLEGE_INFO.map((college, idx) => (
              <motion.div key={college.name} variants={itemVariants}>
                <button
                  type="button"
                  data-ocid={`portal.college.button.${idx + 1}`}
